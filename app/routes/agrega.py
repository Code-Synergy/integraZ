...
class CreateLeadRequest(BaseModel):
    ...
    id_plataforma: Optional[str] = Field(None, description="ID da plataforma (opcional, usa configuração do ambiente)")
...
async def create_lead(
    ...
    # Usa id_plataforma do request ou da configuração
    id_plataforma = req.id_plataforma or settings.agrega_id_plataforma
